...
public class RadioBtn {
    ...
    static void main(String[] args) {
        ...
        //Radio Btn
        WebElement yellowBtn = driver.findElement(By.xpath("//input[@value=\"yellow\"]"));
        System.out.println(yellowBtn.isSelected()); //false
        yellowBtn.click();
        System.out.println(yellowBtn.isSelected()); //True
        System.out.println(yellowBtn.getText());
